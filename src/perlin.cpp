...
const double Perlin::repeat = 4.0;

void Perlin::initPermutation()
{
    for (int x = 0; x < 512; x++)
    {
        Perlin::p[x] = permutation[x % 256];
    }
}
...
int Perlin::inc(int n)
{
    n++;
    if (repeat > 0) n = mod(n, repeat);
    return n;
}
...
double Perlin::noise3(double x, double y, double z)
{
    ...
    aba = Perlin::p[Perlin::p[Perlin::p[    xi ] + inc(yi)] +     zi ];
    aab = Perlin::p[Perlin::p[Perlin::p[    xi ] +     yi ] + inc(zi)];
    abb = Perlin::p[Perlin::p[Perlin::p[    xi ] + inc(yi)] + inc(zi)];
    baa = Perlin::p[Perlin::p[Perlin::p[inc(xi)] +     yi ] +     zi ];
    bba = Perlin::p[Perlin::p[Perlin::p[inc(xi)] + inc(yi)] +     zi ];
    bab = Perlin::p[Perlin::p[Perlin::p[inc(xi)] +     yi ] + inc(zi)];
    bbb = Perlin::p[Perlin::p[Perlin::p[inc(xi)] + inc(yi)] + inc(zi)];
